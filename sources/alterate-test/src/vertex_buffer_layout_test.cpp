...
TEST(vertex_buffer_layout_test, correctly_computes_offsets) {
    ...
    ASSERT_EQ(0, vbl.attribute_offset(0));
...
TEST(vertex_buffer_layout_test, attribute_by_offset_returns_correct_index) {
    ...
    ASSERT_EQ(0, vbl.attribute_by_offset(vbl.attribute_offset(0)));
    ASSERT_EQ(0, vbl.attribute_by_offset(vbl.attribute_offset(1)-1));
    ASSERT_EQ(1, vbl.attribute_by_offset(vbl.attribute_offset(1)));
    ASSERT_EQ(2, vbl.attribute_by_offset(vbl.attribute_offset(2)));
    ASSERT_EQ(3, vbl.attribute_by_offset(vbl.attribute_offset(3)));
