...
TEST(vec_test, vec_4) {
    ...
    v4.z = 15;
    v4.w = 20;
    assert_equals({ 5, 10, 15, 20 }, v4);
}

TEST(vec_test, ctor_initializer_list) {
    test_vec v1 = { 10, 3 };
    assert_equals({ 10, 3 }, v1);
}

TEST(vec_test, ctor_pointer) {
    float a1[2] = { 5, 4 };
    test_vec v1(a1);
    assert_equals({ 5, 4 }, v1);
}
...
TEST(vec_test, ctor_scalar) {
    float a1 = 7.0f;
    test_vec v1(a1);
    assert_equals({ 7, 7 }, v1);
}

TEST(vec_test, set) {
    test_vec v1;
    v1.set(12.32f);
    assert_equals({ 12.32f, 12.32f }, v1);
}
...
TEST(vec_test, sum_mutate) {
    test_vec v1 = { 3, 4 };
    v1 += {7, 1};
    assert_equals({ 10, 5 }, v1);

    v1 += 3;
    assert_equals({ 13, 8 }, v1);

    float x[2] = { -2, -4 };
    v1 += x;
    assert_equals({ 11, 4 }, v1);
}

TEST(vec_test, sum) {
    test_vec v1 = { 3, 4 };
    test_vec v2 = v1 + std::initializer_list<float>({ 7, 1 });
    assert_equals({ 10, 5 }, v2);

    test_vec v3 = v2 + 3;
    assert_equals({ 13, 8 }, v3);

    float x[2] = { -2, -4 };
    test_vec v4 = v3 + x;
    assert_equals({ 11, 4 }, v4);
...
TEST(vec_test, sub_mutate) {
    test_vec v1 = { 3, 4 };
    v1 -= {7, 1};
    assert_equals({ -4, 3 }, v1);

    v1 -= 3;
    assert_equals({ -7, 0 }, v1);
